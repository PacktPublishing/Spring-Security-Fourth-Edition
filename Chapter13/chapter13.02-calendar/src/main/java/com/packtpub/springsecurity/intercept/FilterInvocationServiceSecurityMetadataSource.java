...
public class FilterInvocationServiceSecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
	...
	public FilterInvocationServiceSecurityMetadataSource(SecurityExpressionHandler<FilterInvocation> customWebSecurityExpressionHandler,
			RequestConfigMappingService filterInvocationService) {
		this.expressionHandler = customWebSecurityExpressionHandler;
