...
public class CalendarUser implements Persistable<UUID>, Serializable {
    ...
    public CalendarUser(UUID id, String email, String password, String firstName, String lastName) {
        this.id = id;
