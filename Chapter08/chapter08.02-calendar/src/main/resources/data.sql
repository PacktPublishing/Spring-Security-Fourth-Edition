...
insert into calendar_users(id,email,password,first_name,last_name) values (1,'admin2@example.com','$2a$04$0CF/Gsquxlel3fWq5Ic/ZOGDCaXbMfXYiXsviTNMQofWRXhvJH3IK','Admin','1');
